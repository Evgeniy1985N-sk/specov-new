    ...
    <div class="max-w-(--container) mx-auto px-4 min-[510px]:px-8 xl:px-0">
      <div class="flex gap-8 min-[1280px]:mx-4.5">
        ...
        <div class="flex-1 flex flex-col gap-4 min-[510px]:gap-6">
          <CabinetPageHeader title="Заказы" back-to="/cabinet-corporate/navigation" add-button-text="Новый заказ"
          ...
          <div class="bg-(--Base-White) rounded-xl p-4 min-[870px]:p-5 overflow-hidden">
            ...
            <div
              class="hidden md:grid grid-cols-[120px_1fr_1fr_180px_40px] xl:grid-cols-[160px_1fr_1fr_180px_40px] gap-4 px-4 py-3 text-sm text-(--Text-600) mb-2">
              <div>Заказ</div>

...
<template>
  ...
  >
    <div class="bg-white rounded-xl p-6 relative">
      ...
      <div class="flex flex-col mb-6 pr-8">
        <div class="w-10 h-10 flex justify-center mb-3">
          <img 
            src="/image/cabinet/marker-red.svg" 
            alt="" 
          >
        </div>
      ...
      <p class="text-base text-(--Text-950) mb-6">
        Адрес <span class="font-bold">{{ address }}</span> будет удалён без возможности восстановления.
      </p>

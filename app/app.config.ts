  ...
  ui: {
    ...
    textarea: {
      slots: {
        root: "relative inline-flex items-center",
        base: [
          "focus:ring-gray-400! ring-gray-300! ring-1! rounded-lg! text-sm! leading-5! w-full rounded-md border-0 appearance-none placeholder:text-dimmed focus:outline-none disabled:cursor-not-allowed disabled:opacity-75",
          "transition-colors",
        ],
    ...
    switch: {
      slots: {
        root: "relative flex items-start",
        base: [
          "inline-flex items-center shrink-0 rounded-full border-2 border-transparent focus-visible:outline-2 focus-visible:outline-offset-2 data-[state=unchecked]:bg-gray-100",
          "transition-[background] duration-200 cursor-pointer",
        ],
        container: "flex items-center",
        thumb:
          "group pointer-events-none rounded-full bg-white shadow-lg ring-0 transition-transform duration-200 data-[state=unchecked]:translate-x-0 data-[state=unchecked]:rtl:-translate-x-0 flex items-center justify-center shadow-sm",
        icon: [
          "absolute shrink-0 group-data-[state=unchecked]:text-dimmed opacity-0 size-10/12",
          "transition-[color,opacity] duration-200",
        ],
        wrapper: "ms-2",
        label: "block font-medium text-gray-950 cursor-pointer font-semibold",
        description: "text-muted",
      },
      variants: {
        color: {
          primary: {
            base: "data-[state=checked]:bg-(--Brand-600) focus-visible:outline-primary",
